...
export class DanhSachGheComponent implements OnInit {
  ...
  DanhSachGhe:Array<{SoGhe: number, TenGhe: string, Gia: number, TrangThai: boolean}> = [
  ...
  ngOnInit() {
    ...
    // this.soGheDaDat = 0;
    for(let gheTrongDanhSach of this.DanhSachGhe){
      if(!gheTrongDanhSach.TrangThai){
        this.soGheConLai++;
      }
      else{
        this.soGheDuocChon++;
